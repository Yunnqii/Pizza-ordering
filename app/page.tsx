  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-16 bg-gradient-to-b from-background-start-rgb to-background-end-rgb">
      <h1 className="text-6xl font-bold text-primary mb-8 text-center">
        THE BEST PIZZA IN WOLLONGONG
      </h1>
      <p className="text-2xl text-foreground/80 mb-12 text-center max-w-2xl">
        Indulge in our artisanal pizzas, crafted with passion and the finest
        ingredients. Experience a slice of heaven with every bite.
      </p>
